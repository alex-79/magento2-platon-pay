...
namespace Platon\PlatonPay\Setup;
...
class InstallData implements InstallDataInterface
{
     ...
     */
    const ORDER_STATUS_PROCESSING_FULFILLMENT_CODE = 'platon_payment_successful';
    /**
     * Custom Processing Order-Status label
     */
    const ORDER_STATUS_PROCESSING_FULFILLMENT_LABEL = 'Platon Payment successful';
    /**
     * Custom Order-State code
     */
    const ORDER_STATE_CUSTOM_CODE = 'payment';
    /**
